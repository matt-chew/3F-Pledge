...
public class AdminController extends Components{
			...
			public AdminController() {
				...
				AdminView.addButton(adminButton, window, 5, 110, 40, 40);
				
				registarButton = new JButton();
				AdminView.addButton(registarButton, window, 5, 160, 40, 40);
				
				scholarshipButton = new JButton();
				AdminView.addButton(scholarshipButton, window, 5, 210, 40, 40);
